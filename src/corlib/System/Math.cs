    ...
    public static class Math
    {
        ...
        public static int MultiplyChecked(int a, int b)
        {
            ...
            if (result > int.MaxValue || result < int.MinValue)
               ThrowHelpers.OverflowException("Arithmetic operation resulted in an overflow.");
            return (int)result;
        }
        ...
        {
            // Implementación básica para detección de overflow en multiplicación de long
            // Esta simplificación no detecta todos los casos de overflow pero sirve para el propósito básico
        ...
        {
            // Para ulong la detección de overflow es más compleja
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ConvertToInt32Checked(long value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ConvertToInt32Checked(ulong value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ConvertToInt32Checked(UIntPtr value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint ConvertToUInt32Checked(IntPtr value)
        {
            long longValue = (long)value;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint ConvertToUInt32Checked(long value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long ConvertToInt64Checked(ulong value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong ConvertToUInt64Checked(IntPtr value)
        {
            long longValue = (long)value;
            if (longValue < 0)
                ThrowHelpers.ThrowOverflowException("Arithmetic operation resulted in an overflow.");
            return (ulong)longValue;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong ConvertToUInt64Checked(long value)
        {
            if (value < 0)
                ThrowHelpers.ThrowOverflowException("Arithmetic operation resulted in an overflow.");
            return (ulong)value;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong ConvertToUInt64Checked(IntPtr value, int index)
        {
